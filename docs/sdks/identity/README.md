...
<!-- UsageSnippet language="go" operationID="V3DiscoverRequest" method="get" path="/v3/discover" -->
```go
package main
...
func main() {
    ...
    res, err := s.Identity.V3DiscoverRequest(ctx, "<id>", nil)
    if err != nil {
        log.Fatal(err)
    }
...
**[*operations.V3DiscoverRequestResponse](../../models/operations/v3discoverrequestresponse.md), error**
...
<!-- UsageSnippet language="go" operationID="V3DisenrollIdentity" method="delete" path="/v3/identity/{proveId}" -->
```go
package main
...
<!-- UsageSnippet language="go" operationID="V3GetIdentity" method="get" path="/v3/identity/{proveId}" -->
```go
package main
...
<!-- UsageSnippet language="go" operationID="V3ActivateIdentity" method="post" path="/v3/identity/{proveId}/activate" -->
```go
package main
...
<!-- UsageSnippet language="go" operationID="V3DeactivateIdentity" method="post" path="/v3/identity/{proveId}/deactivate" -->
```go
package main
