...
// V3DeviceRevokeRequest - Revoke Device
// This endpoint allows you to revoke a Prove Key device, marking it as inactive
// so it can no longer be used in an auth flow.
func (s *V3) V3DeviceRevokeRequest(ctx context.Context, request *components.V3DeviceRevokeRequest, opts ...operations.Option) (*operations.V3DeviceRevokeRequestResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	opURL, err := url.JoinPath(baseURL, "/v3/device/revoke")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.V3DeviceRevokeRequestResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.V3DeviceRevokeResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.V3DeviceRevokeResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
